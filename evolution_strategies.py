...
from parameters import (
    num_of_individuos, dimensions, iterations_number, number_of_offspring,
    probability_of_recombination, maxiter, mutation_step
)
...
class ES():
    ...
    def _initialize_population(self):
        ...
        for i in range(num_of_individuos):
            ...
            p = Particle(random_position, random_strategies)
            self.population.append(p)

    def _get_random_number(self):
        return (
            -100 + random.uniform(0, 1) * (100 - (-100))
        )
    ...
    def _crossover_operator(self, parents):
        ...
        for i in range(dimensions):
            ...
            offspring = Particle(position, strategy)
        return offspring
    ...
    def mutate_offspring(self, offspring):
        ...
        new_individuo = Particle(current_position, strategy_parameters)
